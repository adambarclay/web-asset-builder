...
namespace AdamBarclay.WebAssetBuilder.Tests.WebAssetBuilderTask_Tests
{
	...
	public static class Execute_Outputs_File_Compressed_In_The_Gzip_Location
	{
		[Fact]
		public static void When_The_File_Should_Be_Compressed()
		{
			...
			var expectedOutput = FileSystemHelper.ReadAllBytes(
				"AdamBarclay.WebAssetBuilder.Tests.Resources.Output.style.min.css.gzip");
			...
			using (var memoryStream = new MemoryStream())
			{
				fileSystem.Setup(
					o => o.File!.OpenWrite(
						"OutputPath/gzip/css/style-1k2pypdtz1f2y2i3ely4f9jwig46xuu5jqvp5w21gdrrs72usu."))!.Returns(
					memoryStream);
